    ...
    <div class="wrapper">
      <div class="container clearfix">
        ...
        <div class="content">
          ...
          <div class="item-price">{{productInfo.price}}元
          ...
          <div class="item-version clearfix">
            <h2>选择版本</h2>
            <div class="phone fl" :class="{'checked':verison == 1 }" @click="verison = 1">6GB+64GB 全网通</div>
            <div class="phone fr" :class="{'checked':verison == 2 }" @click="verison = 2">4GB+64GB 移动4G</div>
          </div>
          ...
          <div class="item-total">
            <div class="phone-info clearfix">
              <div class="fl">{{productInfo.name}} {{verison == 1 ? '6GB+64GB 全网通 深灰色' : '4GB+64GB 移动4G'}} </div>
